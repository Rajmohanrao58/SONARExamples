...
public class MyJavaFileCheckRegistrar implements CheckRegistrar {
  ...
  public void register(RegistrarContext registrarContext) {
    ...
    registrarContext.registerClassesForRepository(JlinRulesDefinition.JLIN_REPOSITORY_KEY, Arrays.asList(checkClasses()), Arrays.asList(testCheckClasses()));
  }
  ...
  public static Class<? extends JavaCheck>[] checkClasses() {
    return new Class[] {
      ...
      APICompatabilityCheck.class,
      RestrictedComponentCheck.class
    };
  }
